...
public enum ProfilerTask {
  ...
  REPOSITORY_DOWNLOAD("Downloading external file"),
  REPOSITORY_DOWNLOAD_ATTEMPT("Single attempt at downloading an external file"),
  REPOSITORY_DOWNLOAD_CACHE_PROBE("Looking up an external file in a local cache"),
